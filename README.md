[![Build Status](https://github.com/Fred78290/kubernetes-desktop-autoscaler/actions/workflows/build.yml/badge.svg?branch=master)](https://github.com/Fred78290/Fred78290_kubernetes-desktop-autoscaler/actions)
...
kind: "ManagedNode"
metadata:
  name: "desktop-ca-k8s-managed-01"
spec:
  nodegroup: desktop-ca-k8s
  vcpus: 2
  memorySizeInMb: 2048
  diskSizeInMb: 10240
```
  ...
  "cloud-init":
    {
      ...
      "runcmd":
        [
          ...
          "growpart /dev/sda 1",
          "resize2fs /dev/sda1",
          "echo '192.168.1.120 desktop-ca-k8s-masterkube desktop-ca-k8s-masterkube.acme.com' >> /etc/hosts",
        ],
    },
